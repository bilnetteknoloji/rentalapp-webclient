...
import { StaySearchFormFields } from "components/HeroSearchForm2/DVSearch2";
...
const Header: FC<Header3Props> = ({ className = "" }) => {
    ...
    //
    const [currentTab, setCurrentTab] = useState<SearchTab>("Daire & Villa");

    //
    useOutsideAlerter(headerInnerRef, () => {
        setShowHeroSearch(null);
        setCurrentTab("Daire & Villa");
    });
    ...
    return (
        <>
          ...
          ${
                        showHeroSearch
                            ? currentTab === "Uzun Süreli Kiralama" || currentTab === "Ara"
                                ? "scale-y-[4.4]"
                                : "scale-y-[3.4]"
                            : ""
                    }`}
